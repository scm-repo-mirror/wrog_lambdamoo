...
extern Var listrangeset(Var list, int from, int after, Var value);
...
extern Var sublist(Var list, int first, int after);
extern Var strrangeset(Var list, int from, int after, Var value);
extern Var substr(Var str, int first, int after);
