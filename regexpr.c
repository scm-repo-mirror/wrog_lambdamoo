...
#include "execute.h" /* added for LambdaMOO */
...
static int
re_do_compile_fastmap(char * buffer, int used, int pos,
		      char * can_be_null, char * fastmap)
{
...
int
re_match_2(regexp_t bufp, char * string1, int size1, char * string2, int size2,
...
int
re_search_2(regexp_t bufp, char * string1, int size1, char * string2, int size2,
...
int
re_search(regexp_t bufp, char * string, int size,
	  int startpos, int range, regexp_registers_t regs)
{
